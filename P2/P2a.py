...
net = Net.Network([784, 10], cost=Net.CrossEntropyCost)
results = net.SGD(train_data, epochs=20, mini_batch_size=100, eta=0.01, lmbda=0.001,
        test_data=test_data,
...
net.save(filename='.\saved_models\P2a')
